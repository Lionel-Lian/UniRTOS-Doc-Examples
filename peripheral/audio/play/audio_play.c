...
static void audio_play_demo_init(void)
{
    QLOGI("audio play API demo requires a valid audio file path and callback config");
}

UNIRTOS_APP_EXPORT(200, "audio_play_demo", audio_play_demo_init);