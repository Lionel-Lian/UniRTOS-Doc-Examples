...
static void audio_recording_demo_init(void)
{
    QLOGI("audio recording API demo requires a writable file path and recorder config");
}

UNIRTOS_APP_EXPORT(200, "audio_recording_demo", audio_recording_demo_init);