...
static void sms_txt_demo_init(void)
{
    QLOGI("sms txt demo snippet extracted from network/sms/demo/sms_demo.c");
}

UNIRTOS_APP_EXPORT(200, "sms_txt_demo", sms_txt_demo_init);