...
static void __unirtos_export_http_post_form_demo(void)
{
    (void)http_post_form_demo();
}

UNIRTOS_APP_EXPORT(200, "http_post_form_demo", __unirtos_export_http_post_form_demo);